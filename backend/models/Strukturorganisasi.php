...
/**
 * This is the model class for table "strukturorganisasi".
 *
 * @property int $id
...
class Strukturorganisasi extends \yii\db\ActiveRecord
{
    ...
    {
        if ($this->imageFile) {
            $this->image = '/struktur/' . Yii::$app->security->generateRandomString() . '/' . $this->imageFile->name;
        }
