						...
						<div class="header-column">
							<div class="header-row">
								<div class="header-logo">
									<a href="site/index">
										<img src="<?= Yii::$app->getHomeUrl(); ?>img/logos/logo5.png" class="img-fluid" width="70" height="70" alt="" />
										<h6> Departemen Sejarah </h6>
									</a>
								</div>
							</div>
						</div>
										...
										<nav class="collapse">
											<ul class="nav nav-pills" id="mainNav">
												...
												<li class="dropdown">
													...
													<ul class="dropdown-menu">
														<li><a href="demo-auto-services-services-detail.html" class="dropdown-item">Penerimaan Mahasiswa Baru</a></li>
														<li><a href="demo-auto-services-services-detail.html" class="dropdown-item">Kurikulum</a></li>
														<li><a href="demo-auto-services-services-detail.html" class="dropdown-item">Profil Lulusan</a></li>
														<li><a href="demo-auto-services-services-detail.html" class="dropdown-item">CPL</a></li>
														<li><a href="demo-auto-services-services-detail.html" class="dropdown-item">Skripsi</a></li>
														<li><a href="demo-auto-services-services-detail.html" class="dropdown-item">Kalender Akademik</a></li>
														<li><a href="demo-auto-services-services-detail.html" class="dropdown-item">Jaminan Mutu</a></li>
													</ul>
												</li>
												<li class="dropdown">
												...
												<li class="dropdown">
													...
													<ul class="dropdown-menu">
														<li><a href="demo-auto-services-services-detail.html" class="dropdown-item">Diakronika</a></li>
														<li><a href="demo-auto-services-services-detail.html" class="dropdown-item">Kronologi</a></li>
														<li><a href="demo-auto-services-services-detail.html" class="dropdown-item">Ranah Riset</a></li>
													</ul>
												</li>
