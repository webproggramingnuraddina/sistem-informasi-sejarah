                ...
                <div class="row mb-3">
                    <div class="col">
                        <ul class="breadcrumb d-block text-center custom-font-secondary text-6 font-weight-medium positive-ls-3">
                            ...
                            <li class="active text-color-primary">Kelompok Riset</li>
                        </ul>
                        <h1 class="d-block text-color-light font-weight-bold text-center text-12 positive-ls-1 line-height-2 mb-0">Kelompok Riset</h1>
                    </div>
                </div>
            </div>
                ...
                <div class="row flex-row flex-wrap pt-5">
                    <?php foreach ($modelKelompokriset as $key => $val) : ?>
                        <div class="col-lg-6 col-md-6 pb-2">
                            <div class="card border-0 mb-4 border-radius-0 box-shadow-6 appear-animation bg-dark" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="100">
                                <div class="card-body p-3 z-index-1">
                                    <div class="d-flex justify-content-start align-items-center">
                                        <div class="text-white">
                                            <i class="bi bi-journal-bookmark text-white fs-4"></i>
                                            <strong class="font-weight-bold text-white text-5 mt-4 mb-0"><?= $val->nama_riset ?></strong>
                                            <br>
                                            <i class="bi bi-person text-white fs-5"></i>
                                            <strong class="font-weight-bold text-white text-3 mt-2 mb-0"><?= $val->anggota ?></strong>
                                            <!-- <strong class="font-weight-bold text-3 mt-2 mb-0"><?= $val->deskripsi ?></strong> -->
                                            <br>
                                            <p class="text-light bg-white"><?= $val->deskripsi ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
