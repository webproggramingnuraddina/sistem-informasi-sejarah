            ...
            <div class="row mb-3">
                <div class="col">
                    <ul class="breadcrumb d-block text-center custom-font-secondary text-6 font-weight-medium positive-ls-3">
                        ...
                        <li class="active text-color-primary">Mission</li>
                    </ul>
                    <h1 class="d-block text-color-light font-weight-bold text-center text-12 positive-ls-1 line-height-2 mb-0">Mission</h1>
                </div>
            </div>
        </div>
            ...
            <div class="container position-relative z-index-3 my-5">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 order-2 order-lg-1 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
                        ...
                        <h3 class="font-weight-bold text-transform-none text-9 line-height-2 mb-3">Department of History Mission</h3>
                        ...
                        <li class="pt-3 pb-2 mb-2 appear-animation" data-appear-animation="fadeInUpShorter"><i class="fas fa-check text-color-dark border-color-grey-1 top-7"></i> Providing education to produce professional, excellent history teachers capable of developing 21st-century historical learning.</li>
                        <li class="pt-3 pb-2 mb-2 appear-animation" data-appear-animation="fadeInUpShorter"><i class="fas fa-check text-color-dark border-color-grey-1 top-7"></i> Conducting innovative research contributing globally to the field of history education and historical studies.</li>
                        <li class="pt-3 pb-2 mb-2 appear-animation" data-appear-animation="fadeInUpShorter"><i class="fas fa-check text-color-dark border-color-grey-1 top-7"></i> Engaging in community service as a means of contributing to the improvement of character education based on historical values in order to build a competitive society.</li>
