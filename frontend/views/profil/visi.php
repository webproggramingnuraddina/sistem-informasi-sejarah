                    ...
                    <div class="container position-relative z-index-3 my-5">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-6 order-2 order-lg-1 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
                                ...
                                <p class="pt-3 pb-2 mb-2 appear-animation" data-appear-animation="fadeInUpShorter"><?= $val->visi ?></p>
                    ...
                    <div class="container position-relative z-index-3 my-5">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-6 order-2 order-lg-1 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
                                ...
                                <p class="pt-3 pb-2 mb-2 appear-animation" data-appear-animation="fadeInUpShorter"><?= $val->visi_eng ?></p>
