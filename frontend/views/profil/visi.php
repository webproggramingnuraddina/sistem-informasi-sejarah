            ...
            <div class="row mb-3">
                <div class="col">
                    <ul class="breadcrumb d-block text-center custom-font-secondary text-6 font-weight-medium positive-ls-3">
                        ...
                        <li class="active text-color-primary"><?= Yii::t('app', 'Visi') ?></li>
                    </ul>
                    <h1 class="d-block text-color-light font-weight-bold text-center text-12 positive-ls-1 line-height-2 mb-0"><?= Yii::t('app', 'Visi') ?></h1>
                </div>
            </div>
        </div>
            ...
            <div class="container position-relative z-index-3 my-5">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 order-2 order-lg-1 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
                        ...
                        <p class="pt-3 pb-2 mb-2 appear-animation" data-appear-animation="fadeInUpShorter"><?= Yii::t('app', 'Menjadi prodi yang unggul di kawasan Asia Tenggara dalam menyelenggarakan pendidikan sejarah yang menghasilkan tenaga pendidik yang berkarakter, mampu berinovasi, dan terampil dalam mengembangkan pembelajaran yang sesuai dengan perkembangan IPTEK.') ?></p>
